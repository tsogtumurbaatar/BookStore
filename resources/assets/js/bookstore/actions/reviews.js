...
export function fetchReviews(reviewid) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/review/fetch/'+reviewid, { method: 'GET'})
...
export function addReview(review, book_id) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/review/add', { method: 'POST',
...
export function removeReviews(review_ids) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/review/remove', { method: 'POST',
...
export function saveReview(review) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/review/save', { method: 'POST',
