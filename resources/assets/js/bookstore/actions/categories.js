...
export function addCategory(category) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/category/add', { method: 'POST',
...
export function removeCategories(categoriesID) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/category/remove', { method: 'POST',
...
export function fetchCategory(catid) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/category/fetch/'+catid, { method: 'GET'})
		.then( response => Promise.all([response, response.json()]))
		.then(([response, json]) =>{
			if(response.status === 200){
...
export function saveCategory(category) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/category/save', { method: 'POST',
