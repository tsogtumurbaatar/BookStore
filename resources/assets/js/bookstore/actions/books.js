...
export function fetchBooks() {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/book/fetch', { method: 'GET'})
...
export function addBook(book) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/book/add', { method: 'POST',
...
export function removeBooks(book_ids) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/book/remove', { method: 'POST',
...
export function fetchBook(bookid) {
	return (dispatch) => {
		...
		return fetch('http://localhost/bookstore/public/api/book/fetch/'+bookid, { method: 'GET'})
		.then( response => Promise.all([response, response.json()]))
		.then(([response, json]) =>{
			if(response.status === 200){
