...
export class UserReviewsHeader extends React.Component{
	...
	render(){
		...
		return(
			...
			{all_length} reviews, <b>({summary_value_point} out of 5 starts)</b>
			</div>
			...
			<div className ="col-md-2">
			<small>{Math.round(point5array.length*100/all_length)||'0'}%</small>
			</div>
			</div>
			...
			<div className ="col-md-2">
			<small>{Math.round(point4array.length*100/all_length)||'0'}%</small>
			</div>
			</div>
			...
			<div className ="col-md-2">
			<small>{Math.round(point3array.length*100/all_length)||'0'}%</small>
			</div>
			</div>
			...
			<div className ="col-md-2">
			<small>{Math.round(point2array.length*100/all_length)||'0'}%</small>
			</div>
			</div>
			...
			<div className ="col-md-2">
			<small>{Math.round(point1array.length*100/all_length)||'0'}%</small>
			</div>
			</div>
			...
			<div className ="col-md-2">
			<small>{Math.round(point0array.length*100/all_length) ||'0'}%</small>
			</div>
			</div>
