...
export class LanguageForm extends React.Component{
    ...
    subbutton = (<button type="submit" className="btn btn-primary form-control"  onClick={()=>this.handleSaveEvent()}><span className="glyphicon glyphicon-ok"></span> Save Language</button>)
	else
    subbutton = (<button type="submit" className="btn btn-primary form-control"  onClick={()=>this.handleAddEvent()}><span className="glyphicon glyphicon-ok"></span> Add Language</button>)
		...
		return(
			...
			<div className="col-md-6 form-group">	
			<Link to="/language" className="btn btn-warning form-control"><span className="glyphicon glyphicon-share"></span> Go back</Link>
			</div>
